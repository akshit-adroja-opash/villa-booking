      ...
      <div className="mx-auto max-w-[1280px] px-8 py-20 md:px-16 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 md:gap-8 lg:gap-16 w-full">
          ...
          <div className="md:col-span-5 space-y-6">
            ...
            <div className="pt-2">
              <a href="https://wa.me/918780493615" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 bg-[#1B2A22] border border-[#D4AF37]/50 text-[#D4AF37] px-6 py-2.5 rounded-full text-[11px] font-bold uppercase tracking-widest hover:bg-[#D4AF37] hover:text-[#1B2A22] transition-all">
          ...
          <div className="md:col-span-4 space-y-6">
            ...
            <ul className="space-y-6 text-[13px] text-white/60 font-medium">
              <li className="flex flex-col gap-1.5">
                ...
                <span className="text-[10px] uppercase tracking-widest text-[#D4AF37]/70 ml-[34px] font-bold">Online Booking Inquiry (10 AM - 7 PM)</span>
              </li>
              <li className="flex flex-col gap-1.5">
                <div className="flex items-center gap-4 hover:text-[#D4AF37] transition-colors">
                  <Phone className="h-4.5 w-4.5 text-[#D4AF37] shrink-0" />
                ...
                <span className="text-[10px] uppercase tracking-widest text-[#D4AF37]/70 ml-[34px] font-bold">Any Other Queries (10 AM - 7 PM)</span>
              </li>
