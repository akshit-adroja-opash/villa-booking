...
export default function AdminDashboard() {
 ...
 <p className="text-sm font-medium text-[#1B2A22]/60 mt-1">Total Revenue</p>
 </div>
 <LogoMoneyIcon />
 </div>
 <div className="flex justify-end">
 <span className="text-sm font-medium font-bold text-[#1B2A22] bg-[#1B2A22]/10 px-2 py-0.5 tracking-wider">
 +24%
 </span>
 </div>
 </div>
 ...
 <p className="text-sm font-medium text-[#1B2A22]/60 mt-1">Bookings</p>
 </div>
 <LogoBookingsIcon />
 </div>
 <div className="flex justify-end">
 ...
 <p className="text-sm font-medium text-[#1B2A22]/60 mt-1">Guests</p>
 </div>
 <LogoUsersIcon />
 </div>
 <div className="flex justify-end">
 ...
 <p className="text-sm font-medium text-[#1B2A22]/60 mt-1">Avg Occupancy</p>
 </div>
 <LogoOccupancyIcon />
 </div>
 <div className="flex justify-end">
 ...
 className="text-sm font-medium text-[#1B2A22] bg-[#FAF9F6] border border-[#1B2A22]/10 px-3 py-1.5 outline-none cursor-pointer"
 >
 ...
 {/* Dynamic Labels */}
 <div className="flex justify-between items-center text-sm font-medium font-bold text-[#1B2A22]/40 mt-4 px-1">
 {chartData.map((d, idx) => (
 ...
 {/* Legend Block */}
 <div className="flex flex-wrap justify-center gap-x-4 gap-y-2 text-sm font-medium text-[#1B2A22]/60 mt-4">
 {donutSegments.map((segment, idx) => (
 ...
 <span className={`inline-block px-2.5 py-1 text-sm font-medium border ${
