                    ...
                    {[
                        ...
                        <div key={stat.label} className="bg-white border border-[#bfc9c3]/20 rounded-2xl p-6">
                            <div className="flex items-start justify-between">
                                <div>
                                    <p className="text-sm font-medium text-[#707974]">{stat.label}</p>
                            ...
                            {chartRevenueData.map(([month, revenue]) => (
                                <div key={month} className="flex h-full flex-1 flex-col justify-end gap-3">
                                    ...
                                    <div className="text-center space-y-0.5">
                                        ...
                                        <p className="text-sm font-medium text-[#707974] font-semibold">₹{revenue.toLocaleString('en-IN')}</p>
                                    </div>
                                </div>
                            ))}
                        </div>
                                    ...
                                    <div key={property.title} className="rounded-2xl border border-[#bfc9c3]/20 bg-gray-50 p-4 transition-all">
                                        <div className="flex items-center justify-between gap-4">
                                            <div>
                                                ...
                                                <p className="text-sm font-medium text-gray-400 font-semibold mt-0.5">{property.bookings} booking{property.bookings === 1 ? '' : 's'}</p>
                                            </div>
