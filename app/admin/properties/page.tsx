...
export default function AdminPropertiesPage() {
  ...
  const handleDelete = (id: string) => {
    toast.custom((t) => (
      <div
        className={`bg-white border border-gray-100 shadow-[0_10px_40px_rgb(0,0,0,0.12)] rounded-xl p-5 flex flex-col gap-3 max-w-sm w-full mb-4 transition-all duration-500 transform ${t.visible ? 'translate-y-0 opacity-100' : 'translate-y-24 opacity-0'
          }`}
      >
